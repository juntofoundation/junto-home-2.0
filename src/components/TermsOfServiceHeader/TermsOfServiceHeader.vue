<template>
<div class="termsOfServiceHeader" v-if="memberOpen != true">
    ...
    <!-- main body -->
    <div class="termsOfServiceHeader__main">
        <!-- new section -->
        <div class="termsOfServiceHeader__section">
            <p class="termsOfServiceHeader__section--title">1. Acceptance of Terms</p>
            <p class="termsOfServiceHeader__section--body">Junto Foundation, Inc. (“Junto,” “we,” “us”) welcomes you to its online service. By using this Service you are agreeing to the following Terms of Service ("Terms"), whether or not you are a registered user of Junto. The Terms may be updated from time to time without notice to you, though we will strive to always inform you when such updates occur. However, you can always find the latest Terms of Service here and should check regularly for updates and changes.</p>
            <p class="termsOfServiceHeader__section--body">These Terms govern your access to and use of our Services, including our website, SMS, APIs, email notifications, applications, platform, buttons, widgets, communications, commerce and all other covered services that link to these Terms (collectively, the “Services”) and any information, text, links, graphics, photos, audio, videos or other materials or arrangements of materials uploaded, downloaded or appearing on the Services (collectively referred to as “Content”). By using the Services you agree to be bound by these Terms. In addition, when using the Service, you shall be subject to any posted policies, guidelines or rules applicable thereto. All such policies, guidelines and rules are hereby incorporated by reference into these Terms. You further agree that, except as otherwise expressly provided in these Terms, there shall be no third party beneficiaries to this agreement.</p>
            <p class="termsOfServiceHeader__section--body">
                <strong>IF YOU DO NOT AGREE TO THE CURRENT TERMS AND CONDITIONS, PLEASE DO NOT USE THIS SERVICE, SINCE YOUR USE OF IT CONSTITUTES ACCEPTANCE OF ALL OF THE MOST CURRENT TERMS AND CONDITIONS FOR ITS USE.</strong>
            </p>
            <p class="termsOfServiceHeader__section--body">
                <strong>ARBITRATION NOTICE: THESE TERMS CONTAIN AN ARBITRATION CLAUSE A LITTLE LATER ON. EXCEPT FOR CERTAIN TYPES OF DISPUTES MENTIONED IN THAT ARBITRATION CLAUSE, YOU AND JUNTO AGREE THAT DISPUTES BETWEEN US WILL BE RESOLVED BY MANDATORY BINDING ARBITRATION, AND YOU AND JUNTO WAIVE ANY RIGHT TO PARTICIPATE IN A CLASS-ACTION LAWSUIT OR CLASS-WIDE ARBITRATION.</strong>
            </p>
        </div>

        <!--  new section-->
        <div class="termsOfServiceHeader__section">
            <p class="termsOfServiceHeader__section--title">2. The Junto Privacy Policy</p>
            <p class="termsOfServiceHeader__section--body">
                Personal and certain types of other information are subject to our Privacy Policy. As a condition of using the Service you agree to the terms of the Privacy Policy, as it may be changed and updated from time to time. Our Privacy Policy, which is incorporated here by reference, is located at www.junto.foundation/privacy-policy. You agree that your use of this Service is subject to the Privacy Policy, and therefore, agree that you will not use this Service unless and until you review the Privacy Policy and agree with its terms in its entirety.
            </p>
        </div>

        <!--  new section-->
        <div class="termsOfServiceHeader__section">
            <p class="termsOfServiceHeader__section--title">3. Description of Service &amp; Those Who Can't Use It</p>
            <p class="termsOfServiceHeader__section--body">
            ...
            <p class="termsOfServiceHeader__section--body">
                <strong>YOU MUST BE AT LEAST 13 YEARS OF AGE TO ACCESS AND VIEW THE SERVICE, AND YOU MUST BE AT LEAST 18 YEARS OF AGE TO ACCESS AND USE ANY "ADULT" DESIGNATED PORTIONS OF THE SERVICE. IF YOU ARE 13 YEARS OR YOUNGER, DO NOT USE THIS SERVICE FOR ANY PURPOSE AS IT IS NOT INTENDED FOR USE BY CHILDREN.</strong>
            </p>
            <p class="termsOfServiceHeader__section--body">
        ...
        <!--  new section-->
        <div class="termsOfServiceHeader__section">
            <p class="termsOfServiceHeader__section--title">4. Junto Community Guidelines</p>
            <p class="termsOfServiceHeader__section--body">
            ...
            <div class="termsOfServiceHeader__bullet">
                <img src="../../assets/images/junto-home-2.0__bullet.png" alt class="termsOfServiceHeader__bullet--icon" />
                <p class="termsOfServiceHeader__bullet--text">
            ...
            <div class="termsOfServiceHeader__bullet">
                <img src="../../assets/images/junto-home-2.0__bullet.png" alt class="termsOfServiceHeader__bullet--icon" />
                <p class="termsOfServiceHeader__bullet--text">
                    Junto believes in the spirit of authentic, respectful engagement and, therefore, asks that our users not abuse, defame, harass, stalk, threaten, intimidate or otherwise violate the legal rights of others.
                </p>
            </div>
            ...
            <div class="termsOfServiceHeader__bullet">
                <img src="../../assets/images/junto-home-2.0__bullet.png" alt class="termsOfServiceHeader__bullet--icon" />
                <p class="termsOfServiceHeader__bullet--text">
                    You agree to not violate the privacy or publicity rights of others.
                </p>
            </div>
            ...
            <div class="termsOfServiceHeader__bullet">
                <img src="../../assets/images/junto-home-2.0__bullet.png" alt class="termsOfServiceHeader__bullet--icon" />
                <p class="termsOfServiceHeader__bullet--text">
                    You agree to not post, upload or link to (a) anything that promotes or distributes pyramid schemes or chain letters or (b) other disruptive, illegal or immoral communications of any kind.
                </p>
            </div>
            ...
            <div class="termsOfServiceHeader__bullet">
                <img src="../../assets/images/junto-home-2.0__bullet.png" alt class="termsOfServiceHeader__bullet--icon" />
                <p class="termsOfServiceHeader__bullet--text">
                    You agree to not post, upload or link to anything that harvests or otherwise collects information about other users, including, but not limited to, addresses, phone numbers, e-mail addresses and/or health or financial information of any kind without the users’ prior express consent in each instance.
                </p>
            </div>
            ...
            <div class="termsOfServiceHeader__bullet">
                <img src="../../assets/images/junto-home-2.0__bullet.png" alt class="termsOfServiceHeader__bullet--icon" />
                <p class="termsOfServiceHeader__bullet--text">
                    You agree to not upload or post anything that infringes any patent, trademark, copyright, trade secret or other intellectual property or other legal right of a third party without prior written permission from the third party in each instance, and this written permission you agree to disclose to us at any time on our request (subject to all applicable laws). You must not intentionally download any material that you know or should reasonably know cannot be distributed legally.
                </p>
            </div>
            ...
            <div class="termsOfServiceHeader__bullet">
                <img src="../../assets/images/junto-home-2.0__bullet.png" alt class="termsOfServiceHeader__bullet--icon" />
                <p class="termsOfServiceHeader__bullet--text">
                    You agree to not impersonate another person, group of people or entity at any time. This includes not using anyone else's username or password. Note that this does not apply to parody and fan accounts.
                </p>
            </div>
            ...
            <div class="termsOfServiceHeader__bullet">
                <img src="../../assets/images/junto-home-2.0__bullet.png" alt class="termsOfServiceHeader__bullet--icon" />
                <p class="termsOfServiceHeader__bullet--text">
                    You agree to not use the Junto Service for any illegal or unauthorized purpose.
                </p>
            </div>
            ...
            <div class="termsOfServiceHeader__bullet">
                <img src="../../assets/images/junto-home-2.0__bullet.png" alt class="termsOfServiceHeader__bullet--icon" />
                <p class="termsOfServiceHeader__bullet--text">
                    You agree to abide by all applicable federal, state and local laws. If you are outside the United States, you must comply with all local laws, as well, with respect to your online conduct and acceptable Content including, without limitation, the exportation of data to the United States or to your country of residence.
                </p>
            </div>
            ...
            <div class="termsOfServiceHeader__bullet">
                <img src="../../assets/images/junto-home-2.0__bullet.png" alt class="termsOfServiceHeader__bullet--icon" />
                <p class="termsOfServiceHeader__bullet--text">
                    You agree to not transmit any viruses, worms, defects, Trojan Horses or any items and/or computer code, files or programs of a destructive nature and/or otherwise designed to interrupt or limit the functionality of any computer software, hardware or telecommunications device.
                </p>
            </div>
            <div class="termsOfServiceHeader__bullet">
                <img src="../../assets/images/junto-home-2.0__bullet.png" alt class="termsOfServiceHeader__bullet--icon" />
                <p class="termsOfServiceHeader__bullet--text">
                    You agree to not transmit or allow access or distribution of any spiders, robots or other information gathering computer programs or routines or their equivalents on or in the Service.
                </p>
            </div>
            <div class="termsOfServiceHeader__bullet">
                <img src="../../assets/images/junto-home-2.0__bullet.png" alt class="termsOfServiceHeader__bullet--icon" />
                <p class="termsOfServiceHeader__bullet--text">
                    You agree to not interfere with or disrupt the Service, servers or networks connected with the Service or disobey any requirements, procedures, policies or regulations of networks connected to the Service.
                </p>
            </div>
            <div class="termsOfServiceHeader__bullet">
                <img src="../../assets/images/junto-home-2.0__bullet.png" alt class="termsOfServiceHeader__bullet--icon" />
                <p class="termsOfServiceHeader__bullet--text">
                    You agree to not create member accounts under any false or fraudulent pretenses (including by automated means).
                </p>
            </div>
            <div class="termsOfServiceHeader__bullet">
                <img src="../../assets/images/junto-home-2.0__bullet.png" alt class="termsOfServiceHeader__bullet--icon" />
                <p class="termsOfServiceHeader__bullet--text">
                    You agree to not state or imply that any of your submitted and or posted Content is endorsed by Junto or any affiliate thereof.
                </p>
            </div>
            <div class="termsOfServiceHeader__bullet">
                <img src="../../assets/images/junto-home-2.0__bullet.png" alt class="termsOfServiceHeader__bullet--icon" />
                <p class="termsOfServiceHeader__bullet--text">
                    You agree to not retrieve, store or collect personal information about any user for any unauthorized purpose, and you may not retrieve, store or collect personal information about any user for any valid purpose without such user’s prior written consent in each instance (and acknowledgment that they are at least 13 years of age).
                </p>
            </div>
            <div class="termsOfServiceHeader__bullet">
                <img src="../../assets/images/junto-home-2.0__bullet.png" alt class="termsOfServiceHeader__bullet--icon" />
                <p class="termsOfServiceHeader__bullet--text">
                    You agree to not engage in "spamming" of any kind, including, without limitation, ad spamming.
                </p>
            </div>
            <div class="termsOfServiceHeader__bullet">
                <img src="../../assets/images/junto-home-2.0__bullet.png" alt class="termsOfServiceHeader__bullet--icon" />
                <p class="termsOfServiceHeader__bullet--text">
                    You agree to not use the Junto name, trademarks or related trade names, which you acknowledge here to be valid, subsisting and enforceable without impediment, and you will not expressly or by implication create the false or misleading impression that Junto is associated with, endorses, or is in any way connected with you, your business or your Content.
                </p>
            </div>
            <p class="termsOfServiceHeader__section--body">
                <strong> WHILE JUNTO EXPLICITLY PROHIBITS THE ABOVE CONDUCT, YOU ACKNOWLEDGE AND AGREE THAT YOU MAY BE EXPOSED TO SUCH CONDUCT AND CONTENT, THAT YOU USE THE SERVICE ENTIRELY AT YOUR OWN RISK AND THAT JUNTO SHALL HAVE NO LIABILITY OF ANY KIND FOR SUCH CONDUCT AS CARRIED OUT BY ANY THIRD PARTY AT ANY TIME, UNLESS EXPRESSLY SET FORTH TO THE CONTRARY BY JUNTO IN WRITING. </strong>

            </p>
            <p class="termsOfServiceHeader__section--body">
                YOU UNDERSTAND AND AGREE THAT IF YOU VIOLATE ANY OF THE RULES OF BEHAVIOR, JUNTO RESERVES THE RIGHT TO TAKE ACTION, INCLUDING, IN THE MOST EGREGIOUS OF INSTANCES, THE RIGHT TO TERMINATE YOUR USE OF THE SERVICE IMMEDIATELY, WITHOUT PRIOR NOTICE AND WITHOUT ANY RIGHT TO A HEARING.
        ...
        <div class="termsOfServiceHeader__section">
            ...
            <p class="termsOfServiceHeader__section--subtitle">DMCA</p>
            <p class="termsOfServiceHeader__section--body">
        ...
        <!--  new section-->
        <div class="termsOfServiceHeader__section">
            <p class="termsOfServiceHeader__section--title">7. Indemnity</p>
            <p class="termsOfServiceHeader__section--body">
        ...
        <!--  new section-->
        <div class="termsOfServiceHeader__section">
            <p class="termsOfServiceHeader__section--title">8. Open Source Software and Junto Consent</p>
            <p class="termsOfServiceHeader__section--body">
        ...
        <!--  new section-->
        <div class="termsOfServiceHeader__section">
            <p class="termsOfServiceHeader__section--title">9. Modification and Termination of Service</p>
            <p class="termsOfServiceHeader__section--body">
        ...
        <!--  new section-->
        <div class="termsOfServiceHeader__section">
            <p class="termsOfServiceHeader__section--title">10. Registration</p>
            <p class="termsOfServiceHeader__section--body">
            ...
            <div class="termsOfServiceHeader__bullet">
                <img src="../../assets/images/junto-home-2.0__bullet.png" alt class="termsOfServiceHeader__bullet--icon" />
                <p class="termsOfServiceHeader__bullet--text">
                    In consideration of your use of the Service, you represent that you are of legal age, thirteen (13) years, to form a binding contract in the United States, and that you are not a person barred from receiving the Services under the laws of the United States or other applicable jurisdiction
            ...
            <div class="termsOfServiceHeader__bullet">
                <img src="../../assets/images/junto-home-2.0__bullet.png" alt class="termsOfServiceHeader__bullet--icon" />
                <p class="termsOfServiceHeader__bullet--text">
                    With the exception of Junto’s memorialization settings, you agree that your account is non-transferable and any rights to your account, password and username, terminate upon your death or disability and/or termination of account for any reason.
        ...
        <!--  new section-->
        <div class="termsOfServiceHeader__section">
            <p class="termsOfServiceHeader__section--title">14. Disclaimer of Warranties</p>
            <p class="termsOfServiceHeader__section--body">
        ...
        <!--  new section-->
        <div class="termsOfServiceHeader__section">
            <p class="termsOfServiceHeader__section--title">15. Limitation of Liability</p>
            <p class="termsOfServiceHeader__section--body">
        ...
        <!--  new section-->
        <div class="termsOfServiceHeader__section">
            <p class="termsOfServiceHeader__section--title">16. Personally Identifiable Information</p>
            <p class="termsOfServiceHeader__section--body">
        ...
        <!--  new section-->
        <div class="termsOfServiceHeader__section">
            <p class="termsOfServiceHeader__section--title">17. Disclosures Required by Law</p>
            <p class="termsOfServiceHeader__section--body">
                While Junto reserves the right at all times to disclose any information, including personally identifiable information about you, as necessary, the only real reasons we may actually end up doing so are if the law legally requires us to arising out of the following situations: (i) to satisfy a valid subpoena issued in connection to a criminal investigation; (ii) a court order issued under 18 U.S.C. Section 2703(d); or (iii) a valid search warrant issued upon the showing of probable cause. Junto reserves the right to fully cooperate with any law enforcement authorities or court order requesting or directing us to disclose the identity of anyone posting any content, publishing or otherwise making available any materials that are believed to violate these Terms. We will use reasonable efforts to notify you in connection with any such inquiry; provided, however, that the inquiry in question is not confidential, and further provided that Junto shall have no duty to disclose such information and therefore shall not be liable to you in connection with any non-disclosure.
            </p>
            <p class="termsOfServiceHeader__section--body">
                BY ACCEPTING THIS AGREEMENT, YOU WAIVE ALL RIGHTS AND AGREE TO HOLD JUNTO HARMLESS FROM ANY CLAIMS RESULTING FROM ANY ACTION TAKEN BY JUNTO DURING OR AS A RESULT OF ITS INVESTIGATIONS AND/OR FROM ANY ACTIONS TAKEN AS A CONSEQUENCE OF INVESTIGATIONS BY EITHER JUNTO OR ANY LAW ENFORCEMENT OR REGULATORY AUTHORITIES.
            </p>
        ...
        <!--  new section-->
        <div class="termsOfServiceHeader__section">
            <p class="termsOfServiceHeader__section--title">18. Arbitration, Class-Action Waiver and Jury Waiver</p>
            <p class="termsOfServiceHeader__section--body">
        ...
        <!--  new section-->
        <div class="termsOfServiceHeader__section">
            <p class="termsOfServiceHeader__section--title">19. Choice of Law and Venue</p>
            <p class="termsOfServiceHeader__section--body">
        ...
        <!--  new section-->
        <div class="termsOfServiceHeader__section">
            <p class="termsOfServiceHeader__section--title">20. Miscellaneous Terms; General Information</p>
            <p class="termsOfServiceHeader__section--body">
