...
<div class="termsOfServiceHeader" v-if="memberOpen != true">
    ...
    <div class="termsOfServiceHeader__main">
        ...
        <div class="termsOfServiceHeader__section">
            ...
            <p class="termsOfServiceHeader__section--body">
                <strong>YOU MUST BE AT LEAST 13 YEARS OF AGE TO ACCESS AND VIEW THE SERVICE, AND MUST BE AT LEAST 18 YEARS OF AGE TO ACCESS AND USE ANY "ADULT" DESIGNATED PORTIONS OF THE SERVICE. IF YOU ARE 13 YEARS OR YOUNGER, DO NOT USE THIS SERVICE FOR ANY PURPOSE AS IT IS NOT INTENDED FOR USE BY CHILDREN.</strong>
            </p>
            <p class="termsOfServiceHeader__section--body">
        ...
        <div class="termsOfServiceHeader__section">
            ...
            <div class="termsOfServiceHeader__bullet">
                <img src="../../assets/images/junto-home-2.0__bullet.png" alt class="termsOfServiceHeader__bullet--icon" />
                <p class="termsOfServiceHeader__bullet--text">
                    Junto believes in the spirit of authentic, respectful engagement, and therefore ask that our users not abuse, defame, harass, stalk, threaten, intimidate, or otherwise violate the legal rights of others.
                </p>
            </div>
            ...
            <div class="termsOfServiceHeader__bullet">
                <img src="../../assets/images/junto-home-2.0__bullet.png" alt class="termsOfServiceHeader__bullet--icon" />
                <p class="termsOfServiceHeader__bullet--text">
                    You agree not to violate the privacy or publicity rights of others.
                </p>
            </div>
            ...
            <div class="termsOfServiceHeader__bullet">
                <img src="../../assets/images/junto-home-2.0__bullet.png" alt class="termsOfServiceHeader__bullet--icon" />
                <p class="termsOfServiceHeader__bullet--text">
                    You cannot agree not to create member accounts under any false or fraudulent pretenses (including by automated means).
                </p>
            </div>
            <div class="termsOfServiceHeader__bullet">
                <img src="../../assets/images/junto-home-2.0__bullet.png" alt class="termsOfServiceHeader__bullet--icon" />
        ...
        <div class="termsOfServiceHeader__section">
            ...
            <p class="termsOfServiceHeader__section--body">
                As a registered user, you will be able to upload and post a great variety of materials and information, including but not limited to text, audio, video, photographs, graphics and other materials ("Content"). This means that you have the sole responsibility, not Junto, for all of the Content that you upload, post, email, transmit or otherwise make available through the Service, and to make sure that you are in compliance with the rules of behavior set forth herein relating to such Content. <strong>Any Content that you write, post, upload or link to on Junto is entirely your responsibility.</strong>
            </p>
