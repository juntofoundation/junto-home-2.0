  ...
  <div class="homePillars">
    ...
    <div class="homePillars__pillars">
      <div class="homePillars__pillar">
        <img
          src="../../../assets/images/junto-home-2.0__pillar--design.png"
          alt=""
      ...
      <div class="homePillars__pillar homePillars__pillar--middle">
        <img
          src="../../../assets/images/junto-home-2.0__pillar--decentralized.png"
          alt=""
          class="homePillars__pillar--icon"
        />
      ...
      <div class="homePillars__pillar">
        <img
          src="../../../assets/images/junto-home-2.0__pillar--nonprofit.png"
          alt=""
          class="homePillars__pillar--icon"
        />
