    ...
    <div class="privacyPolicyHeader" v-if="memberOpen != true">
        ...
        <div class="privacyPolicyHeader__main">
            <div class="privacyPolicyHeader__section">
                ...
                <p class="privacyPolicyHeader__section--body">Before diving into the specifics, let’s get a few things out of the way:</p>
                ...
                <div class="privacyPolicyHeader__bullet">
                    <img src="../../assets/images/junto-home-2.0__bullet.png" alt class="privacyPolicyHeader__bullet--icon" />
                    <p class="privacyPolicyHeader__bullet--text">We DO NOT run targeted advertisements. Junto does not facilitate the use of targeted advertisements on our App. However, you may still see third-party advertisements from time to time independent of us. This is because we do not restrict our users from posting their own advertisements; we just won’t have a hand in the facilitation of any posted ads.</p>
                </div>
            </div>
            ...
            <div class="privacyPolicyHeader__section">
                ...
                <div class="privacyPolicyHeader__bullet">
                    <img src="../../assets/images/junto-home-2.0__bullet.png" alt class="privacyPolicyHeader__bullet--icon" />
                    <p class="privacyPolicyHeader__bullet--text">AWS (Privacy Policy): Used by us to store, process and distribute information.</p>
                </div>
                <div class="privacyPolicyHeader__bullet">
                    <img src="../../assets/images/junto-home-2.0__bullet.png" alt class="privacyPolicyHeader__bullet--icon" />
                    <p class="privacyPolicyHeader__bullet--text">Sentry (Privacy Policy): Used by us to log anonymous reports on bugs and crashes happening in the Junto App.</p>
                </div>
            </div>
            ...
            <div class="privacyPolicyHeader__section">
                ...
                <div class="privacyPolicyHeader__bullet">
                    <img src="../../assets/images/junto-home-2.0__bullet.png" alt class="privacyPolicyHeader__bullet--icon" />
                    <p class="privacyPolicyHeader__bullet--text">When you register an account with us, you provide us with personally identifiable information like name, email address, phone number, username and password, etc. Furthermore, you have the ability to add more information to your profile after registration (e.g., bio, location, personal website, etc.).</p>
                </div>
                <div class="privacyPolicyHeader__bullet">
                    <img src="../../assets/images/junto-home-2.0__bullet.png" alt class="privacyPolicyHeader__bullet--icon" />
                ...
                <div class="privacyPolicyHeader__bullet">
                    <img src="../../assets/images/junto-home-2.0__bullet.png" alt class="privacyPolicyHeader__bullet--icon" />
                    <p class="privacyPolicyHeader__bullet--text">Occasionally, you may voluntarily provide information to us to complete surveys and questionnaires or to participate in user polls. We use this information to improve our products &amp; Services and to ensure that we’re providing accurate disclosures.</p>
                </div>
                ...
                <div class="privacyPolicyHeader__bullet">
                    <img src="../../assets/images/junto-home-2.0__bullet.png" alt class="privacyPolicyHeader__bullet--icon" />
                    <p class="privacyPolicyHeader__bullet--text">Crash Reporting. Junto automatically collects crash logs through a third party service. These logs, however, do not contain any user information beyond device model and OS.</p>
                </div>
            </div>
            ...
            <div class="privacyPolicyHeader__section">
                ...
                <p class="privacyPolicyHeader__section--body">We DO NOT believe in collecting and using any of the following:</p>
                <div class="privacyPolicyHeader__bullet">
                    <img src="../../assets/images/junto-home-2.0__bullet.png" alt class="privacyPolicyHeader__bullet--icon" />
                    <p class="privacyPolicyHeader__bullet--text">Cookies, web beacons or other technologies to receive and store certain types of your personal information as you interact with our Services</p>
                </div>
                <div class="privacyPolicyHeader__bullet">
                    <img src="../../assets/images/junto-home-2.0__bullet.png" alt class="privacyPolicyHeader__bullet--icon" />
                    <p class="privacyPolicyHeader__bullet--text">Certain analytics and viewer interactions services in connection with the operation of a site, including the collection and tracking of certain data and information regarding the characteristics and activities of visitors to a site (i.e., micro-interactions). To give you a better idea, popular services used by others, not us, include MixPanel and UXCam</p>
                </div>
                <div class="privacyPolicyHeader__bullet">
                    <img src="../../assets/images/junto-home-2.0__bullet.png" alt class="privacyPolicyHeader__bullet--icon" />
                    <p class="privacyPolicyHeader__bullet--text">IP addresses, user agents, or other unique technical identifiers and network activity information (e.g., browsing history, search history, or interactions with a third-party application).</p>
                </div>
            </div>
            ...
            <div class="privacyPolicyHeader__section">
                ...
                <div class="privacyPolicyHeader__item">
                    ...
                    <p class="privacyPolicyHeader__item--body">You may have the right to require us to erase/delete your account. When deactivated, your account, including your display name, username, content and public profile, will no longer be viewable on Junto. It is important to remember, though, that search engines and other third parties may still retain copies of pieces of public information, even after you have deleted the information from our Services or deactivated your account.</p>
                </div>
                <div class="privacyPolicyHeader__item">
                    <p class="privacyPolicyHeader__item--title">Right to Restriction of Processing</p>
                    <p class="privacyPolicyHeader__item--body">You may have the right to require us to restrict the further processing your personal information. In such cases, the respective information will be marked as restricted, and may only be processed by us for certain purposes.</p>
                </div>
                <div class="privacyPolicyHeader__item">
                    <p class="privacyPolicyHeader__item--title">Right to Object</p>
                    <p class="privacyPolicyHeader__item--body">You may have the right to object, on grounds relating to your particular situation, to the processing of your personal information by us, and we may be required to no longer process some or all of your personal information.</p>
                </div>
                <div class="privacyPolicyHeader__item">
                    <p class="privacyPolicyHeader__item--title">Right to Data Portability</p>
                    <p class="privacyPolicyHeader__item--body">In the near future, you will have the right to receive a copy of your personal information which you have provided to us, in a structured, commonly used, and machine-readable format. Rest assured, we will let you know when this is readily available.</p>
                </div>
                <div class="privacyPolicyHeader__item">
                    <p class="privacyPolicyHeader__item--title">Right to Withdraw Consent</p>
                    <p class="privacyPolicyHeader__item--body">You may have the right to withdraw consent you have provided to us where we rely solely on your consent to process your personal information. You can always provide your consent to us again at a later time.</p>
                </div>
                <div class="privacyPolicyHeader__item">
                    <p class="privacyPolicyHeader__item--title">Right to Complain</p>
                    <p class="privacyPolicyHeader__item--body">You may have the right to lodge a complaint to an applicable supervisory authority or other regulator if you are not satisfied with our responses to your requests or how we manage your personal information. For example, if you are located in the EU/EEA, a list of and more information about the EU/EEA Data Protection Authorities can be found here: http://ec.europa.eu/justice/data-protection/bodies/authorities/index_en.htm. We encourage you to first reach out to us at hi@junto.foundation, so we have an opportunity to address your concerns directly.</p>
                    <p class="privacyPolicyHeader__item--body">When we receive formal written complaints, we respond by contacting the person who made the complaint. We work with the appropriate regulatory authorities, including local data protection authorities, to resolve any complaints regarding the transfer of your data that we cannot resolve with you directly.</p>
                </div>
                <div class="privacyPolicyHeader__item">
                    <p class="privacyPolicyHeader__item--title">Your Choice to Exercise Your Rights.</p>
                    <p class="privacyPolicyHeader__item--body">If you make the choice to exercise any of these rights, email us at hi@junto.foundation. Please understand, though, that you will need to provide us with (i) enough information to identify you, like your name, address, and account details; (ii) proof of your identity; and (iii) a description of what right you want to exercise and the information you are requesting. Most of the information necessary for you to exercise any rights should be easily accessible within the App. However, if for some reason we are unable to verify that the person making the request is the person whom we have information about, we reserve the right to refrain from disclosing any data. We do this so that we can ensure we only share one’s data with the rightful owner. Also, know that any personal information we collect from you to verify your identity in connection with a request will be used solely for the purposes of verification.</p>
                </div>
            </div>
            ...
            <div class="privacyPolicyHeader__section">
                ...
                <p class="privacyPolicyHeader__section--body">If you have any questions or comments about this Policy, the ways in which we collect and use your personal information, your choices and rights regarding such use, or wish to exercise your rights, please do not hesitate to contact us at hi@junto.foundation.</p>
            </div>
