      ...
      <div class="footer__socials">
        ...
        >
          <img
            ...
            src="../../assets/images/junto-home-2.0__email.png"
            alt
          />
        ...
        >
          <img
            class="footer__social--icon footer__social--icon--large"
            src="../../assets/images/junto-home-2.0__twitter.png"
            alt
          />
        ...
        <a
          href="https://github.com/juntofoundation"
          target="blank"
          class="removelink footer__social"
        >
          <img
            class="footer__social--icon"
            src="../../assets/images/junto-home-2.0__github.png"
            alt
          />
        ...
        >
          <img
            class="footer__social--icon"
            src="../../assets/images/junto-home-2.0__instagram.png"
            alt
          />
